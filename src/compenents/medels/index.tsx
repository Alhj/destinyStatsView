      ...
      <div className="medel">
        ...
        >
          <div className="medelsComponent">
            ...
            <h3>
              Blood For Blood:{" "}
              {accMedles.medalAvenger.basic.value
                ? accMedles.medalAvenger.basic.displayValue
                : 0}
            </h3>
          </div>
          <div className="medelsComponent">
            ...
            <h3>
              Best Served Cold:{" "}
              {accMedles.medalPayback.basic.value
                ? accMedles.medalPayback.basic.displayValue
                : 0}
            </h3>
          </div>
          <div className="medelsComponent">
            ...
            <h3>
              Ruthless:{" "}
              {accMedles.medalStreak5x.basic.value
                ? accMedles.medalStreak5x.basic.displayValue
                : 0}
            </h3>
          </div>
          <div className="medelsComponent">
            ...
            <h3>
              Quick Strike:{" "}
              {accMedles.medalQuickStrike.basic.value
                ? accMedles.medalQuickStrike.basic.displayValue
                : 0}
            </h3>
          </div>
          <div className="medelsComponent">
            ...
            <h3>
              Unyielding:{" "}
              {accMedles.medalStreak10x.basic.value
                ? accMedles.medalStreak10x.basic.displayValue
                : 0}
            </h3>
          </div>
          <div className="medelsComponent">
            ...
            <h3>
              Barricade Breaker:{" "}
              {accMedles.medalDefeatTitanBrace.basic.value
                ? accMedles.medalDefeatTitanBrace.basic.displayValue
                : 0}
            </h3>
          </div>
          <div className="medelsComponent">
            ...
            <h3>
              Dodge This:{" "}
              {accMedles.medalDefeatHunterDodge.basic.value
                ? accMedles.medalDefeatHunterDodge.basic.displayValue
                : 0}
            </h3>
          </div>
          <div className="medelsComponent">
            ...
            <h3>
              Rift Breaker:{" "}
              {accMedles.medalDefeatWarlockSigil.basic.value
                ? accMedles.medalDefeatWarlockSigil.basic.displayValue
                : 0}
            </h3>
          </div>
        </div>
